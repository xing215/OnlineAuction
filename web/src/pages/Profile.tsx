...
export default function ProfilePage() {
    ...
    // Mock data: Sản phẩm đang đấu giá (endTime ở tương lai)
    ...
    const biddingProducts: Product[] = [
        {
            ...
            endTime: new Date(Date.now() + 2 * 60 * 60 * 1000), // Còn 2 tiếng
            bidCount: 45,
            seller: "TechStore VN",
        ...
        },
        {
            ...
            endTime: new Date(Date.now() + 24 * 60 * 60 * 1000), // Còn 1 ngày
            bidCount: 23,
            seller: "LuxuryWatch",
            category: "Watches",
        },
    ...
    // Mock data: Sản phẩm đã thắng (endTime ở quá khứ)
    ...
    const wonProducts: Product[] = [
        {
            ...
            endTime: new Date(Date.now() - 100000), // Đã kết thúc
            bidCount: 12,
            seller: "BookWorm",
            category: "Books",
        },
        {
            ...
            endTime: new Date(Date.now() - 500000), // Đã kết thúc
            bidCount: 156,
            seller: "MusicWorld",
