      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-1 space-y-1">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="truncate">Người bán: <span className="font-medium text-gray-800">{typeof product.seller === 'object' ? product.seller.full_name : (product.seller || 'Ẩn danh')}</span></span>
          </div>
